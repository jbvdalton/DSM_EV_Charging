...
/t1.w1=333.13,t2.w1=300.48,t3.w1=350.00,t4.w1=363.37,t5.w1=337.81,t6.w1=332.12,t7.w1=272.70,
...
/t1=184.555,t2=184.378,t3=181.343,t4=218.208,t5=247.362,t6=296.668,t7=623.666,
t8=615.274,t9=617.564,t10=617,t11=617.634,t12=621.569,t13=584.74,t14=575.481,
t15=314.487,t16=177.54/

u(t,i,w)                bnary parameter equal to 1 when ith vehicle is between T_arr & T_dep
      /t1 .i1 .w1 = 1, t2 .i1 .w1 = 1,t15.i1 .w1 = 1,
	   t3 .i1 .w1 = 1, t4 .i1 .w1 = 1,t5 .i1 .w1 = 1,
	   t6 .i1 .w1 = 1, t7 .i1 .w1 = 1,t8 .i1 .w1 = 1,
	   t9 .i1 .w1 = 1, t10.i1 .w1 = 1,t11.i1 .w1 = 1,
	   t12.i1 .w1 = 1, t13.i1 .w1 = 1,t14.i1 .w1 = 1,
...
Full_eq(t,i,w) .. Full(t,i,w) =e= 1$(SOC.l(t,i,w) ge 0.9);
...
Display
profit.l, A.l, B.l, R.l, E_DA.l, Delta_E.l, R_DA.l, E_RTi.l, E_RT.l, SOC.l, Full.l
;
