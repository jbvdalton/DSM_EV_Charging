...
Fee_DA					Trading fee DA /0.41/
Fee_RT					Trading fee RT /1.13/
;
...
Aeq .. A =e= 1/1000 * sum(t,(LambdaDA(t)+Fee_DA) * E_DA(t));			
Beq .. B =e= 1/1000 * sum(w, Pi(w) * sum(t,(LambdaRT(t,w) * Delta_E(t,w)) 
+ abs(Delta_E(t,w)) * Fee_RT));
...
Solve
Maxprofit using DNLP maximizing Profit
;
