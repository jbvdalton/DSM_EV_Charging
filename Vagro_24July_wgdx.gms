...
Parameters
Pi(w)                   Probability of scenario w 
LambdaDA(t)				DA price 
...
$GDXIN /Users/jacobdalton/Dropbox/EG230X_MSc_Tibber/04_Code/Jacob/July24Scen.gdx
$LOAD  Pi, LambdaDA, LambdaRT, LambdaR, u, Ebat_max, P_ch, T_arr, T_dep, SOC_arr, SOC_dep
$GDXIN
...
*E_DAeq(t) .. E_DAo(t) =e= E_DA(t)+EPS;

*acronym O
*R_DA(t) $ (R_DA(t) eq 0) = O;
...
Execute_unload
 '/Users/jacobdalton/Dropbox/EG230X_MSc_Tibber/04_Code/Jacob/Vagro24July.gdx'
;
